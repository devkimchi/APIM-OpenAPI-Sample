...
az deployment group create -n ApiManagement_Api -g rg-$RESOURCE_NAME -f https://raw.githubusercontent.com/devkimchi/APIM-OpenAPI-Sample/main/Resources/provision-apimanagementapi.bicep -p name=$RESOURCE_NAME
